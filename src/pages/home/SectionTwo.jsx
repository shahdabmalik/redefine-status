...
const SectionTwo = () => {
    return (
        <div id="deeperdive" className='overflow-hidden bg-blue-100 dark:bg-blue-950 relative' >
            <div className="max-w-screen-xl mx-auto px-4 md:px-10 pt-16 pb-36" >
                ...
                <div className="mt-8 text-slate-700 dark:text-slate-200" >
                    ...
                    <img data-aos="zoom-out" src={image1} alt="image" className="sm:max-w-sm lg:max-w-md xl:max-w-lg w-full rounded-md shadow-lg sm:float-right sm:ml-5 mt-5 mb-8 sm:mb-5" />
                    ...
                    <img data-aos="zoom-out" src={image2} alt="image" className="sm:max-w-sm lg:max-w-md xl:max-w-lg w-full rounded-md shadow-lg sm:float-left sm:mr-5 mt-5 mb-8 sm:mb-5" />
