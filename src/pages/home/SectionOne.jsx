...
const SectionOne = () => {
    return (
        <div className='relative' >
            <div className="dark:bg-slate-950 bg-white w-full min-h-screen flex flex-col items-center justify-center px-4 md:px-10 relative" >
                <div className='max-w-md' >
                    <Lottie animationData={animation} />
                </div>
                <h1 className="font-extrabold inline bg-clip-text bg-gradient-to-r from-blue-400 to-violet-500 text-transparent text-4xl sm:text-5xl md:text-6xl lg:text-8xl text-center rounded-2xl mb-2 font-inter" >REDEFINE STATUS</h1>
                <p className="mb-8 text-center text-xl md:text-2xl font-semibold text-slate-950 dark:text-slate-100" >How We Can Correct Mankind&apos;s Leaderboard </p>
