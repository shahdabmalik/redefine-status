...
const SectionOne = () => {
    return (
        <div className='dark:bg-slate-950 bg-slate-100 relative' >
            <div className="w-full min-h-screen flex flex-col items-center justify-center " >
                <Navbar />
                <div className='max-w-md' >
                    <Lottie animationData={animation} />
                </div>
                <h1 className="font-extrabold text-slate-900 dark:text-slate-100 text-6xl md:text-7 lg:text-8xl text-center rounded-2xl mb-4 font-inter" >REDEFINE STATUS</h1>
                <p className="mb-8 text-center text-2xl font-bold text-slate-950 " >How We Can Correct Mankind&apos;s Leaderboard </p>
                <div className="h-1/4 w-full absolute bottom-0 left-0 bg-gradient-to-b from-transparent  dark:to-slate-950 to-slate-100" ></div>
            </div>
            <div className=" w-full max-w-screen-xl mx-auto pt-24 pb-36 px-4 md:px-10 relative" >
                ...
                <div className='mt-8' >
                    <img className='md:max-w-sm lg:max-w-md xl:max-w-2xl w-full rounded-md shadow-lg md:float-right md:ml-5 mb-8 md:mb-5' src={image1} alt='image' />
            ...
            <div className="h-36 w-full absolute bottom-0 left-0 bg-gradient-to-b from-transparent  dark:to-blue-800/40 to-blue-200" ></div>
        </div>
    )
}
