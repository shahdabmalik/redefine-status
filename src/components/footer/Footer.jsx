...
const Footer = () => {
    return (
        <div className="w-full bg-slate-100 dark:bg-slate-950 text-slate-800 dark:text-slate-100" >
            <div className='w-full max-w-screen-xl mx-auto px-4 md:px-10 flex justify-between flex-wrap gap-8 pb-16' >
                <div>
